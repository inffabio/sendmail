import sys, os
ApplicationDirectory = 'projeto'
ApplicationName = 'sendmail'
VirtualEnvDirectory = 'sendmailvenv'
VirtualEnv = os.path.join(os.getcwd(), VirtualEnvDirectory, 'bin', 'python3.7')
